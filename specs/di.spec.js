...
describe('DI module', function () {
    ...
    describe('get method', function () {
        ...
        it('should create new instances with proper this context', function () {
            var instance,
                alma = jasmine.createSpy('alma').andCallFake(function () {
                    expect(this instanceof alma).toBe(true, '[this] is not instance of [alma]');
                });
            di.register('Alma', alma);
            instance = di.get('Alma');
            expect(instance).toBeDefined();
            expect(alma).toHaveBeenCalled();
        });
    });
